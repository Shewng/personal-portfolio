      ...
      <div className={styles["about-row-container"]}>
        <div className={styles["about-me-container"]}>
          ...
          <p>
            ...
            development. I aspire towards a career which allows me to unlock my
            full creative potential, sparking joy to the end users of my work
            and helping people through their problems.
            <br />
            <br />
            I’ve been developing myself as a person outside of my career, using
            a quote as motivation: the more you learn, the easier it is to learn
